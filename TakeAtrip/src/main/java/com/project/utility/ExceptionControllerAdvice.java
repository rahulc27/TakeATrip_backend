...
public class ExceptionControllerAdvice {
	 ...
	 * 
	 * @ExceptionHandler(TakATripException.class) public ResponseEntity<ErrorInfo>
	 * infyBankexceptionHandler(TakATripException exception) { ErrorInfo error = new
	 * ErrorInfo();
	 * error.setErrorMessage(environment.getProperty(exception.getMessage()));
	 * error.setTimestamp(LocalDateTime.now());
	 * error.setErrorCode(HttpStatus.NOT_FOUND.value()); return new
	 * ResponseEntity<ErrorInfo>(error, HttpStatus.NOT_FOUND); }
	 */
